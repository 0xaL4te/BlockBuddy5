...
class SafeAuthKit {
    ...
    async signIn() {
        ...
        const ethersProvider = new ethers_1.ethers.providers.Web3Provider(__classPrivateFieldGet(this, _SafeAuthKit_pack, "f").provider);
        const signer = ethersProvider.getSigner();
        const address = await signer.getAddress();
        let safes;
        // Retrieve safes if txServiceUrl is provided
        if ((_a = __classPrivateFieldGet(this, _SafeAuthKit_config, "f")) === null || _a === void 0 ? void 0 : _a.txServiceUrl) {
            try {
    ...
    getProvider() {
        var _a;
        if (!__classPrivateFieldGet(this, _SafeAuthKit_pack, "f"))
            return null;
        return (_a = __classPrivateFieldGet(this, _SafeAuthKit_pack, "f")) === null || _a === void 0 ? void 0 : _a.provider;
    }
    /**
    ...
    async getUserInfo() {
        ...
        if (!__classPrivateFieldGet(this, _SafeAuthKit_pack, "f"))
            return null;
        return (_a = __classPrivateFieldGet(this, _SafeAuthKit_pack, "f")) === null || _a === void 0 ? void 0 : _a.getUserInfo();
    }
    /**
...
_SafeAuthKit_pack = new WeakMap(), _SafeAuthKit_config = new WeakMap(), _SafeAuthKit_instances = new WeakSet(), _SafeAuthKit_getSafeCoreClient = function _SafeAuthKit_getSafeCoreClient() {
    var _a, _b;
    if (!((_a = __classPrivateFieldGet(this, _SafeAuthKit_pack, "f")) === null || _a === void 0 ? void 0 : _a.provider)) {
        throw new Error('Provider is not defined');
    }
    if (!((_b = __classPrivateFieldGet(this, _SafeAuthKit_config, "f")) === null || _b === void 0 ? void 0 : _b.txServiceUrl)) {
        throw new Error('txServiceUrl is not defined');
    }
    const provider = new ethers_1.ethers.providers.Web3Provider(__classPrivateFieldGet(this, _SafeAuthKit_pack, "f").provider);
