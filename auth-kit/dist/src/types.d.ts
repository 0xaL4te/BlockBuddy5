...
export type SafeAuthEventListener<TPack> = TPack extends Web3AuthModalPack ? Web3AuthEventListener : never;
export type SafeSignInResponse<TPack> = TPack extends Web3AuthModalPack ? void : never;
export type SafeGetUserInfoResponse<TPack> = TPack extends Web3AuthModalPack ? Partial<UserInfo> : never;
