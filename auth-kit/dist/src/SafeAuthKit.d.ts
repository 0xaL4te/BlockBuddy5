...
import { ISafeAuthKit, SafeAuthPack, SafeAuthConfig, SafeAuthEvent, SafeAuthEventListener, SafeAuthSignInData } from './types';
/**
...
export declare class SafeAuthKit<TPack extends SafeAuthPack<TPack>> implements ISafeAuthKit<TPack> {
     ...
     */
    static init<TPack extends SafeAuthPack<TPack>>(pack: TPack, config?: SafeAuthConfig): Promise<SafeAuthKit<TPack>>;
    /**
