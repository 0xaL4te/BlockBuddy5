...
class Web3AuthModalPack {
    ...
    async init() {
        var _a;
        try {
            this.web3authInstance = new modal_1.Web3Auth(__classPrivateFieldGet(this, _Web3AuthModalPack_options, "f"));
            (_a = __classPrivateFieldGet(this, _Web3AuthModalPack_adapters, "f")) === null || _a === void 0 ? void 0 : _a.forEach((adapter) => { var _a; return (_a = this.web3authInstance) === null || _a === void 0 ? void 0 : _a.configureAdapter(adapter); });
            await this.web3authInstance.initModal({ modalConfig: __classPrivateFieldGet(this, _Web3AuthModalPack_modalConfig, "f") });
...
_Web3AuthModalPack_options = new WeakMap(), _Web3AuthModalPack_adapters = new WeakMap(), _Web3AuthModalPack_modalConfig = new WeakMap();
