...
describe('SafeAuthKit', () => {
    ...
    it('should create a SafeAuthKit instance', async () => {
        ...
        expect(safeAuthKit === null || safeAuthKit === void 0 ? void 0 : safeAuthKit.safeAuthData).toBeUndefined();
    });
    ...
    it('should allow to get the provider', async () => {
        const safeAuthKit = await SafeAuthKit_1.SafeAuthKit.init(web3AuthModalPack);
        expect(safeAuthKit === null || safeAuthKit === void 0 ? void 0 : safeAuthKit.getProvider()).toBe(mockProvider);
    });
    it('should allow to subscribe to events', async () => {
        const safeAuthKit = await SafeAuthKit_1.SafeAuthKit.init(web3AuthModalPack);
        const signedIn = jest.fn();
        const signedOut = jest.fn();
        safeAuthKit === null || safeAuthKit === void 0 ? void 0 : safeAuthKit.subscribe(base_1.ADAPTER_EVENTS.CONNECTED, signedIn);
        safeAuthKit === null || safeAuthKit === void 0 ? void 0 : safeAuthKit.subscribe(base_1.ADAPTER_EVENTS.DISCONNECTED, signedOut);
        testingUtils.lowLevel.mockRequest('eth_accounts', [
            '0xf61B443A155b07D2b2cAeA2d99715dC84E839EEf'
        ]);
        await (safeAuthKit === null || safeAuthKit === void 0 ? void 0 : safeAuthKit.signIn());
    ...
    it('should allow to unsubscribe to events', async () => {
        ...
        safeAuthKit === null || safeAuthKit === void 0 ? void 0 : safeAuthKit.subscribe(base_1.ADAPTER_EVENTS.CONNECTED, signedIn);
        safeAuthKit === null || safeAuthKit === void 0 ? void 0 : safeAuthKit.subscribe(base_1.ADAPTER_EVENTS.DISCONNECTED, signedOut);
        safeAuthKit === null || safeAuthKit === void 0 ? void 0 : safeAuthKit.unsubscribe(base_1.ADAPTER_EVENTS.CONNECTED, signedIn);
        safeAuthKit === null || safeAuthKit === void 0 ? void 0 : safeAuthKit.unsubscribe(base_1.ADAPTER_EVENTS.DISCONNECTED, signedOut);
        testingUtils.lowLevel.mockRequest('eth_accounts', [
            '0xf61B443A155b07D2b2cAeA2d99715dC84E839EEf'
        ]);
        await (safeAuthKit === null || safeAuthKit === void 0 ? void 0 : safeAuthKit.signIn());
    ...
    describe('using the Web3AuthModalPack', () => {
        ...
        it('should return the associated eoa when the user is signed in', async () => {
            ...
            const data = await (safeAuthKit === null || safeAuthKit === void 0 ? void 0 : safeAuthKit.signIn());
            expect(data).toEqual({
